                                    ...
                                    <div className="g-connected">
                                        ...
                                        <div className="f-social-link">
                                            <ul>
                                                ...
                                                <li>
                                                    <a target="_blank" href="https://discord.gg/terraspaces">
                                                ...
                                                <li>
                                                    <a target="_blank" href="https://twitter.com/terraspaces">
                                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <li>
                                                    <a target="_blank" href="https://terraspaces.medium.com/">
                                                        <svg width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <li>
                                                    <a target="_blank" href="https://www.youtube.com/channel/UCgOPSm97OL7bMBhr7A_BGFg">
